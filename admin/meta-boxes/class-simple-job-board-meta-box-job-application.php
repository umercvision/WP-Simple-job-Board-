                ...
                if (NULL != $keys):
                    foreach ($keys as $key):
                        if ( substr($key, 0, 7 ) == 'jobapp_' ):
                            ...
                            echo '<input type="checkbox" class="jobapp-required-field" ' . $is_required . ' />' . esc_html__('Required', 'simple-job-board') . ' &nbsp; ';
        ...
        <table id="jobapp_form_fields" class="alignleft">
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="checkbox" id="jobapp_required_field" checked="checked" /><?php esc_html_e('Required', 'simple-job-board'); ?></td>
                    <td><input type="radio" id="jobapp-applicant-columns" /><?php esc_html_e('Expose in Applicant Listing', 'simple-job-board'); ?></td>
